...
Points (red = Russia, blue = Ukraine) represent cumulative losses for each day, bar's represent daily losses. The line repreents a loess smooth on cumulative losses to date; the shaded grey band represents the 95% confidence interval based on extant veriation. A wider grey band means more uncertainty, a narrower grey band means less uncertainty. 

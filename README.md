...
This calculation subtracts units captured by each combatant with their other loss types (destroyed, damaged, and abandoned). It is arguable if a proportion of abandoned should be included as captures. Ukraine has a net positive change in equipment - meaning they've captured more than they've lost. Russia however has lost many more units than it has acquired from Ukraine. 

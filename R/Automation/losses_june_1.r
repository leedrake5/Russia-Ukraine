...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_total.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_destroyed <- ggplot(destroyed_melt, aes(Date, Destroyed, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_destroyed.jpg", current_destroyed, device="jpg", width=6, height=5)
...
destroyed_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/destroyed_ratio.jpg", destroyed_ratio, device="jpg", width=6, height=5)
...
current_abandoned <- ggplot(abandoned_melt, aes(Date, Abandoned, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_abandoned.jpg", current_abandoned, device="jpg", width=6, height=5)
...
abandoned_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/abandoned_ratio.jpg", abandoned_ratio, device="jpg", width=6, height=5)
...
current_captured <- ggplot(captured_melt, aes(Date, Captured, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_captured.jpg", current_captured, device="jpg", width=6, height=5)
...
captured_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/captured_ratio.jpg", captured_ratio, device="jpg", width=6, height=5)
...
current_damaged <- ggplot(damaged_melt, aes(Date, Damaged, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_damaged.jpg", current_damaged, device="jpg", width=6, height=5)
...
damaged_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/damaged_ratio.jpg", damaged_ratio, device="jpg", width=6, height=5)
...
current_grid <- ggplot(all_melt, aes(Date, Number, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_grid.jpg", current_grid, device="jpg", width=6, height=10)
...
ratio_plot <- ggplot(data=all_types, aes(Date, Ratio, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/ratio_grid.jpg", ratio_plot, device="jpg", width=6, height=10)
...
current_tanks <- ggplot(tanks_melt, aes(Date, Tanks, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_tanks.jpg", current_tanks, device="jpg", width=6, height=5)
...
tank_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/tank_ratio.jpg", tank_ratio, device="jpg", width=6, height=5)
...
current_afv <- ggplot(afv_melt, aes(Date, AFV, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_afv.jpg", current_afv, device="jpg", width=6, height=5)
...
afv_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/afv_ratio.jpg", afv_ratio, device="jpg", width=6, height=5)
...
artillery_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/artillery_ratio.jpg", artillery_ratio, device="jpg", width=6, height=5)
...
current_ifv <- ggplot(ifv_melt, aes(Date, IFV, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_ifv.jpg", current_ifv, device="jpg", width=6, height=5)
...
ifv_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/ifv_ratio.jpg", ifv_ratio, device="jpg", width=6, height=5)
...
current_apc <- ggplot(apc_melt, aes(Date, APC, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_apc.jpg", current_apc, device="jpg", width=6, height=5)
...
apc_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/apc_ratio.jpg", apc_ratio, device="jpg", width=6, height=5)
...
current_imv <- ggplot(imv_melt, aes(Date, IMV, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_imv.jpg", current_imv, device="jpg", width=6, height=5)
...
imv_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/imv_ratio.jpg", imv_ratio, device="jpg", width=6, height=5)
...
current_ev <- ggplot(ev_melt, aes(Date, EV, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_ev.jpg", current_ev, device="jpg", width=6, height=5)
...
ev_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/ev_ratio.jpg", ev_ratio, device="jpg", width=6, height=5)
...
current_vehicles <- ggplot(vehicles_melt, aes(Date, Vehicles, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_vehicles.jpg", current_vehicles, device="jpg", width=6, height=5)
...
vehicle_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/vehicle_ratio.jpg", vehicle_ratio, device="jpg", width=6, height=5)
...
current_aircraft <- ggplot(aircraft_melt, aes(Date, Aircraft, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_aircraft.jpg", current_aircraft, device="jpg", width=6, height=5)
...
aircraft_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/aircraft_ratio.jpg", aircraft_ratio, device="jpg", width=6, height=5)
...
current_antiair <- ggplot(antiaircraft_melt, aes(Date, Antiair, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_antiair.jpg", current_antiair, device="jpg", width=6, height=5)
...
antiair_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/antiair_ratio.jpg", antiair_ratio, device="jpg", width=6, height=5)
...
current_infantry <- ggplot(infantry_melt, aes(Date, Infantry, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_infantry.jpg", current_infantry, device="jpg", width=6, height=5)
...
infantry_ratio <-
  ...
  ggtitle(paste0("Anti-air system loss ratio through ", Sys.Date())) +
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/infantry_ratio.jpg", infantry_ratio, device="jpg", width=6, height=5)
...
current_armor <- ggplot(armor_melt, aes(Date, Armor, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_armor.jpg", current_armor, device="jpg", width=6, height=5)
...
armor_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/armor_ratio.jpg", armor_ratio, device="jpg", width=6, height=5)
...
current_logistics <- ggplot(logistics_melt, aes(Date, Logistics, colour=Country)) +
  ...
  scale_colour_manual(values = country_colors)  + 
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_logistics.jpg", current_logistics, device="jpg", width=6, height=5)
...
logistics_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/logistics_ratio.jpg", logistics_ratio, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_loss_type.jpg", loss_type, device="jpg", width=6, height=5)
...
unit_type <- ggplot(equipment_ratios_t[equipment_ratios_t$Type %in% c("Aircraft", "Antiair", "Artillery", "Infantry", "Armor", "Vehicles", "Logistics"),], aes(Type, Ratio, colour=Type, fill=Type)) +
  ...
  #scale_fill_brewer(palette="Accent") +
  #scale_color_brewer(palette="Accent")
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_unit_type.jpg", unit_type, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_total_tanks.jpg", current_percent_total_tanks, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_total_tanks_baseline.jpg", current_percent_total_tanks, device="jpg", width=6, height=5, dpi=600)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_deployed_tanks.jpg", current_percent_deployed_tanks, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_deployed_tanks_baseline.jpg", current_percent_deployed_tanks, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_afv.jpg", current_percent_afv, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_total_afv_baseline.jpg", current_percent_total_afv, device="jpg", width=6, height=5, dpi=600)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_percent_total_armor_baseline.jpg", current_percent_total_armor, device="jpg", width=6, height=5, dpi=600)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/current_absolute_total.jpg", current_absolute_total, device="jpg", width=6, height=5, dpi=600)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/north_firms_summary_plot.jpg", north_firms_summary_plot, device="jpg", width=6, height=5, dpi=600)
...
ggsave("~/Github/Russia-Ukraine/Plots_2023-06-01/south_firms_summary_plot.jpg", south_firms_summary_plot, device="jpg", width=6, height=5, dpi=600)

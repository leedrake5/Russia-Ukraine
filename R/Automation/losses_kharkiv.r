...
write.csv(total_mod, "~/GitHub/Russia-Ukraine/data/Naalsio/kharkiv.csv")
write.csv(total_mod, "~/GitHub/Russia-Ukraine/Apps/zapMap/data/kharkiv.csv")
...
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_total.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_ratio.jpg", current_ratio, device="jpg", width=6, height=5)

###Total Map
kharkiv <- ggmap::get_map(location=c(lon=36.662428, lat=50.125067), source="google", maptype="roadmap", crop=FALSE, zoom=10)

kharkiv_map <- ggmap(kharkiv) +
...
kharkiv_data_plots <- cowplot::plot_grid(kharkiv_total, kharkiv_ratio, ncol=1)

kharkiv_all <- cowplot::plot_grid(kharkiv_map, kharkiv_data_plots, ncol=2)

ggsave("~/Github/Russia-Ukraine/Maps/kharkiv_all.jpg", kharkiv_all, device="jpg", width=12, height=5, dpi=600)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_destroyed.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/destroyed_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_abandoned.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/abandoned_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_captured.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/captured_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_damaged.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/damaged_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_tanks.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/tank_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_afv.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/afv_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_artillery.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/artillery_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_vehicles.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/vehicle_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_armor.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/armor_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots/kharkiv/current_unit_type.jpg", unit_type, device="jpg", width=6, height=5)

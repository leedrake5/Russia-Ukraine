...
russia <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/15B71fIQbY5jiLAFDl1bFROhJsjYjzBNdJJxmkciBmkg", sheet="Russian Losses")
...
ukraine <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/15B71fIQbY5jiLAFDl1bFROhJsjYjzBNdJJxmkciBmkg", sheet="Ukrainian Losses")
...
write.csv(total_mod, "~/GitHub/Russia-Ukraine/data/Naalsio/krynky.csv")
write.csv(total_mod, "~/GitHub/Russia-Ukraine/Apps/zapMap/data/krynky.csv")
...
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_total.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_ratio.jpg", current_ratio, device="jpg", width=6, height=5)

###Total Map
krynky <- ggmap::get_map(location=c(lon=33.096206, lat=46.752941), source="google", maptype="roadmap", crop=FALSE, zoom=12)

krynky_map <- ggmap(krynky) +
...
ggtitle(paste0("Krynky on ", Sys.Date())) +
scale_colour_manual(values = country_colors)  +
theme_light()
...
krynky_data_plots <- cowplot::plot_grid(krynky_total, krynky_ratio, ncol=1)

krynky_all <- cowplot::plot_grid(krynky_map, krynky_data_plots, ncol=2)

ggsave("~/Github/Russia-Ukraine/Maps/krynky_all.jpg", krynky_all, device="jpg", width=12, height=5, dpi=600)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_destroyed.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/destroyed_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_abandoned.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/abandoned_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_captured.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/captured_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_damaged.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/damaged_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_tanks.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/tank_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_afv.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/afv_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_artillery.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/artillery_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_vehicles.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/vehicle_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_armor.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/krynky/armor_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots/krynky/current_unit_type.jpg", unit_type, device="jpg", width=6, height=5)

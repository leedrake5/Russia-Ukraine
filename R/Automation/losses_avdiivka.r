...
russia <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1VIyACYHfnJi8cUMWjXAXDhS419l9IHcIhGJaK1RWMFQ", sheet="Russian Losses")
...
ukraine <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1VIyACYHfnJi8cUMWjXAXDhS419l9IHcIhGJaK1RWMFQ", sheet="Ukrainian Losses")
...
write.csv(total_mod, "~/GitHub/Russia-Ukraine/data/Naalsio/avdiivka.csv")
write.csv(total_mod, "~/GitHub/Russia-Ukraine/Apps/zapMap/data/avdiivka.csv")
...
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_total.jpg", current_total, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_destroyed.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/destroyed_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_abandoned.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/abandoned_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_captured.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/captured_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_damaged.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/damaged_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_tanks.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/tank_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_afv.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/afv_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_artillery.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/artillery_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_vehicles.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/vehicle_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
current_total <-
  ...
  scale_colour_manual(values = country_colors)  +
  scale_fill_manual(values = country_colors)
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_armor.jpg", current_total, device="jpg", width=6, height=5)
...
current_ratio <-
  ...
  theme_light()
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/armor_ratio.jpg", current_ratio, device="jpg", width=6, height=5)
...
ggsave("~/Github/Russia-Ukraine/Plots/avdiivka/current_unit_type.jpg", unit_type, device="jpg", width=6, height=5)
